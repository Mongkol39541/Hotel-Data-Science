...
if (!isset($_COOKIE['se_code']) || isset($_GET['code'])) {
    $set_code = 1;
        ...
        <div class="container">
            ...
            <div class="tab-pane fade show active" id="pills-1" role="tabpanel" aria-labelledby="tab-login">
                ...
                <div class="text-center mb-4">
                    ...
                    <p>Please check your email. We sent your code to: <a href="forget.php?code=1">Didn't get a code?</a></p>
                ...
                <div class="form-floating" style="display:none;">
                    <input type="password" class="form-control" id="change-form" name="change-form" value="passwordform">
                </div>
            ...
            <div class="tab-pane fade" id="pills-2" role="tabpanel" aria-labelledby="tab-register">
                ...
                <div class="form-floating" style="display:none;">
                    <input type="password" class="form-control" id="updatePass" name="updatePass" value="forgotaccount">
                </div>
