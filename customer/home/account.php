...
<body>
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                            ...
                            if (mysqli_num_rows($selectRoomType) > 0) {
                                while($row = mysqli_fetch_row($selectRoomType)) {
                                    echo '<li><a class="dropdown-item" href="test.php?type='.$row[0].'" target="_blank">'.$row[0].'</a></li>';
                                }
                            }
                            ?>
                        </ul>
    ...
    <div class="container">
        ...
        if (mysqli_num_rows($selectRoomType) > 0) {
            while($row = mysqli_fetch_row($selectRoomType)) {
                echo '<a class="btn btn-primary me-2" role="button" href="test.php?type='.$row[0].'" target="_blank">'.$row[0].'</a>';
            }
        }
        ?>
    </div>
