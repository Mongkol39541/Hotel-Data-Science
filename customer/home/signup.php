<!-- ระบบสมัครสมาชิก -->
<!-- In process : ใช้salt-password เปลี่ยนวิธีการสร้างIDใหม่ ใช้required connect.php ปิดstmt ตรวจสอบการUpdateไม่สำเร็จ-->
...
<?php
    ...
    //ตรวจสอบและเก็บข้อมูลจากฟอร์มสมัครสมาชิก
    if(
        isset($_POST['prefix']) &&
    ...
    if (
        ...
        if (mysqli_num_rows($check_email) > 0) {
            ...
            //บันทึกข้อมูลลงฐานข้อมูล ด้วยคำสั่ง mysqli prepare
            $role = 'customer';
            ...
            if ($affectedRows > 0) {
                ...
                $insert_sql = "INSERT INTO member VALUES('$customer','$new_id')";
