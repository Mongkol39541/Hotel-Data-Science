        ...
        <div class="container">
            ...
            <div class="tab-pane fade show active" id="pills-1" role="tabpanel" aria-labelledby="tab-login">
                ...
                <div class="text-center mb-4">
                    ...
                    <p>Please check your email. We sent your code to: <a href="change-email.php?code=1">Didn't get a code?</a></p>
                ...
                <div class="form-floating" style="display:none;">
                    <input type="password" class="form-control" id="change-form" name="change-form" value="emailform">
                </div>
            ...
            <div class="tab-pane fade" id="pills-2" role="tabpanel" aria-labelledby="tab-register">
                <form method="post" id="newpassword" action="update-email.php">
                <div class="text-center mb-4">
