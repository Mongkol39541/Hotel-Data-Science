        ...
        <nav id="main-navbar" class="navbar navbar-expand-lg navbar-light bg-white fixed-top">
            <div class="container-fluid">
                ...
                <ul class="navbar-nav ms-auto d-flex flex-row">
                    ...
                    <a class="nav-link me-3 me-lg-0" href="https://github.com/Mongkol39541/Hotel-Data-Science.git"
                        target="_blank">
        ...
        <div class="container text-center text-md-start mt-5">
            <div class="row mt-3">
                ...
                <div class="col-md-2 mx-auto">
                    ...
                    <div class='row'>
                        <p class='col'>
                            <a href="https://www.w3schools.com/html/default.asp" class="text-reset"
                                target="_blank">HTML</a>
                        </p>
                        <p class='col'>
                            <a href="https://www.w3schools.com/css/default.asp" class="text-reset"
                                target="_blank">CSS</a>
                        </p>
                        <p class='col'>
                            <a href="https://www.w3schools.com/js/default.asp" class="text-reset"
                                target="_blank">Javascript</a>
                        </p>
                        <p class='col'>
                            <a href="https://mdbootstrap.com/docs/standard/getting-started/installation/"
                                class="text-reset" target="_blank">MDBootstrap</a>
                        </p>
                        <p class='col'>
                            <a href="https://www.w3schools.com/php/default.asp" class="text-reset"
                                target="_blank">PHP</a>
                        </p>
                        <p class='col'>
                            <a href="https://www.w3schools.com/mysql/default.asp" class="text-reset"
